                      ...
                      subtitle: Column(
                        children: [
                          CheckboxListTile(
                            ...
                            title: Text('Живой', style: TextStyle(color: Colors.white, fontSize: 16)),
                            checkColor: ColorPalette.bg,
                          ...
                          CheckboxListTile(
                            controlAffinity: ListTileControlAffinity.leading,
                            title: Text('Мёртвый', style: TextStyle(color: Colors.white, fontSize: 16)),
                            checkColor: ColorPalette.bg,
                            activeColor: ColorPalette.blue,
                          ...
                          CheckboxListTile(
                            controlAffinity: ListTileControlAffinity.leading,
                            title: Text('Неизвестно', style: TextStyle(color: Colors.white, fontSize: 16)),
                            checkColor: ColorPalette.bg,
                            activeColor: ColorPalette.blue,
                    ...
                    FilterItem(
                      ...
                      subtitle: Column(
                        children: [
                          CheckboxListTile(
                            controlAffinity: ListTileControlAffinity.leading,
                            title: Text('Мужской', style: TextStyle(color: Colors.white, fontSize: 16)),
                            checkColor: ColorPalette.bg,
                            activeColor: ColorPalette.blue,
                          ...
                          CheckboxListTile(
                            controlAffinity: ListTileControlAffinity.leading,
                            title: Text('Женский', style: TextStyle(color: Colors.white, fontSize: 16)),
                            checkColor: ColorPalette.bg,
                            activeColor: ColorPalette.blue,
                          ...
                          CheckboxListTile(
                            controlAffinity: ListTileControlAffinity.leading,
                            title: Text('Бесполый', style: TextStyle(color: Colors.white, fontSize: 16)),
                            checkColor: ColorPalette.bg,
                            activeColor: ColorPalette.blue,
